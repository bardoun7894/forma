            ...
            <div className="min-h-screen bg-dark flex items-center justify-center p-4">
                <div className="max-w-md w-full text-center">
                    ...
                    <div className="bg-white/5 rounded-2xl p-6 mb-8">
                        ...
                        <p className="text-sm text-muted">{t('newBalance')}: <span className="text-white font-semibold">{newCredits}</span></p>
                    </div>
                ...
                {isProcessing && (
                    <div className="fixed inset-0 bg-dark/90 backdrop-blur-sm flex items-center justify-center z-50">
                        <div className="text-center">
                            ...
                            <p className="text-white text-lg font-medium">{t('processing')}</p>
                            <p className="text-muted text-sm mt-1">{t('doNotClose')}</p>
                        </div>
                    </div>
                )}
                ...
                <div className="max-w-6xl mx-auto px-4 py-8 lg:py-16">
                    <div className="grid lg:grid-cols-2 gap-8 lg:gap-16">
                        ...
                        <div className="order-2 lg:order-1">
                            ...
                            <div className="bg-white/5 rounded-2xl p-6 mb-6">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-muted mb-2">{pack.description}</p>
                            ...
                            {/* What's Included */}
                            <div className="bg-white/5 rounded-2xl p-6 mb-6">
                                <h4 className="text-sm font-medium text-muted uppercase tracking-wider mb-4">{t('whatsIncluded')}</h4>
                        ...
                        <div className="order-1 lg:order-2">
                            <div className="lg:sticky lg:top-8">
                                ...
                                <div className="bg-white/5 rounded-2xl p-6 lg:p-8">
                                    {/* Security Header */}
                                    <div className="flex items-center justify-center gap-2 text-sm text-muted mb-6 pb-6 border-b border-white/10">
                                    ...
                                    <div className="text-center mb-6">
                                        <p className="text-xs text-muted mb-3">{t('acceptedMethods')}</p>
